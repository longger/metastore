      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i271 in xrange(_size267):
            ...
            self.arguments.append(_elem272)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i278 in xrange(_size274):
            _elem279 = SFileLocation()
            _elem279.read(iprot)
            self.locations.append(_elem279)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 10:
        ...
        if ftype == TType.LIST:
          ...
          for _i284 in xrange(_size280):
            ...
            self.ref_files.append(_elem285)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 12:
...
class Index:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i299 in xrange(_size295):
            ...
            self.parameters[_key300] = _val301
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 10:
  ...
  def write(self, oprot):
    ...
    if self.parameters is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.parameters))
      for kiter302,viter303 in self.parameters.items():
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i308 in xrange(_size304):
            _elem309 = ColumnStatisticsObj()
            _elem309.read(iprot)
            self.statsObj.append(_elem309)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class Schema:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i315 in xrange(_size311):
            ...
            _elem316.read(iprot)
            self.fieldSchemas.append(_elem316)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.MAP:
          ...
          for _i321 in xrange(_size317):
            ...
            self.properties[_key322] = _val323
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.fieldSchemas is not None:
      ...
      for iter324 in self.fieldSchemas:
        iter324.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.properties is not None:
      ...
      for kiter325,viter326 in self.properties.items():
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i331 in xrange(_size327):
            ...
            self.properties[_key332] = _val333
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
