...
class statfs:
  ...
  def __init__(self, from=None, to=None, increate=None, close=None, replicated=None, rm_logical=None, rm_physical=None, underrep=None, overrep=None, linger=None, suspect=None, inc_ons=None, inc_ons2=None, cls_offs=None, incs=None, clos=None,):
    self.from = from
    self.to = to
...
class Subpartition:
  ...
  def write(self, oprot):
    ...
    if self.parameters is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.parameters))
      for kiter202,viter203 in self.parameters.items():
...
class Partition:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i228 in xrange(_size224):
            _elem229 = Subpartition()
            _elem229.read(iprot)
            self.subpartitions.append(_elem229)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 11:
  ...
  def write(self, oprot):
    ...
    if self.subpartitions is not None:
      ...
      for iter234 in self.subpartitions:
        iter234.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.version is not None:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i239 in xrange(_size235):
            ...
            self.parameters[_key240] = _val241
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 8:
...
class Table:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i248 in xrange(_size244):
            _elem249 = FieldSchema()
            _elem249.read(iprot)
            self.partitionKeys.append(_elem249)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 10:
        if ftype == TType.MAP:
          ...
          for _i254 in xrange(_size250):
            ...
            self.parameters[_key255] = _val256
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 11:
        ...
        if ftype == TType.LIST:
          ...
          for _i261 in xrange(_size257):
            _elem262 = NodeGroup()
            _elem262.read(iprot)
            self.nodeGroups.append(_elem262)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 15:
        ...
        if ftype == TType.LIST:
          ...
          for _i267 in xrange(_size263):
            _elem268 = Partition()
            _elem268.read(iprot)
            self.partitions.append(_elem268)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 17:
        if ftype == TType.LIST:
          ...
          for _i273 in xrange(_size269):
            ...
            _elem274.read(iprot)
            self.fileSplitKeys.append(_elem274)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitionKeys is not None:
      ...
      for iter275 in self.partitionKeys:
        iter275.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.parameters is not None:
      oprot.writeFieldBegin('parameters', TType.MAP, 10)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.parameters))
      for kiter276,viter277 in self.parameters.items():
    ...
    if self.nodeGroups is not None:
      ...
      for iter278 in self.nodeGroups:
        iter278.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.privileges is not None:
    ...
    if self.partitions is not None:
      ...
      for iter279 in self.partitions:
        iter279.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.fileSplitKeys is not None:
      ...
      for iter280 in self.fileSplitKeys:
        iter280.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i285 in xrange(_size281):
            ...
            self.arguments.append(_elem286)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i292 in xrange(_size288):
            _elem293 = SFileLocation()
            _elem293.read(iprot)
            self.locations.append(_elem293)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 10:
        ...
        if ftype == TType.LIST:
          ...
          for _i298 in xrange(_size294):
            ...
            self.ref_files.append(_elem299)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 12:
...
class Index:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i313 in xrange(_size309):
            ...
            self.parameters[_key314] = _val315
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 10:
  ...
  def write(self, oprot):
    ...
    if self.parameters is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.parameters))
      for kiter316,viter317 in self.parameters.items():
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i322 in xrange(_size318):
            _elem323 = ColumnStatisticsObj()
            _elem323.read(iprot)
            self.statsObj.append(_elem323)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class Schema:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i329 in xrange(_size325):
            _elem330 = FieldSchema()
            _elem330.read(iprot)
            self.fieldSchemas.append(_elem330)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.MAP:
          ...
          for _i335 in xrange(_size331):
            ...
            self.properties[_key336] = _val337
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.fieldSchemas is not None:
      ...
      for iter338 in self.fieldSchemas:
        iter338.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.properties is not None:
      ...
      for kiter339,viter340 in self.properties.items():
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i345 in xrange(_size341):
            ...
            self.properties[_key346] = _val347
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
