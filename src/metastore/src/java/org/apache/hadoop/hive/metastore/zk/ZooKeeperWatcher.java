...
//  public static String namespaceZNode = "namespace";
   ...
   */
  public ZooKeeperWatcher(Configuration conf, String zkString,String identifier,
      Abortable abortable) throws ZooKeeperConnectionException, IOException {
    this(conf, zkString,identifier, abortable, false);
  }
...
//      ZKUtil.createAndFailSilent(this, recoveringRegionsZNode);
  ...
  private void setNodeNames(Configuration conf) {
    baseZNode = conf.get(MetaConstants.ZOOKEEPER_ZNODE_PARENT,
