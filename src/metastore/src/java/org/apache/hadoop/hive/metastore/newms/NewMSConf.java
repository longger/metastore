...
public class NewMSConf {
	...
	public NewMSConf(Set<String> sentinels, RedisMode redisMode, String zkaddr, String mshost, int msport, int rpcport)
	{
	...
	public NewMSConf(List<RedisInstance> redisIns, RedisMode redisMode, String zkaddr, String mshost, int msport, int rpcport)
	{
