...
import org.apache.hadoop.hive.serde2.lazy.objectinspector.primitive.LazyBlobObjectInspector;
import org.apache.hadoop.io.BytesWritable;

public class LazyBlob extends LazyPrimitive<LazyBlobObjectInspector, BytesWritable> {

  private static final Log LOG = LogFactory.getLog(LazyBlob.class);

  LazyBlob(LazyBlobObjectInspector oi) {
    super(oi);
    data = new BytesWritable();
  }

  public LazyBlob(LazyBlob other){
    super(other);
